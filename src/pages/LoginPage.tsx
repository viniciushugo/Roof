    ...
    >
      <div className="flex-1 flex flex-col justify-center py-10">
        ...
        <motion.div
          ...
          className="space-y-3"
        >
          {/* Apple — required per App Store Guideline 4.8 */}
          <button
            onClick={handleApple}
            disabled={appleLoading}
            className="w-full h-14 rounded-2xl bg-foreground text-background flex items-center justify-center gap-3 text-[15px] font-semibold active:opacity-80 transition-opacity disabled:opacity-60"
          >
